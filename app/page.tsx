    ...
    <UiShell>
      <div className="flex flex-col gap-10 pb-10">
        ...
        <section className="flex flex-col gap-6 text-center items-center pt-8 pb-4">
          <div className="flex items-center justify-center bg-muted/60 text-muted-foreground px-4 py-1 rounded-full text-xs font-medium border border-border/50 backdrop-blur-sm transition-all hover:bg-muted">
            <ShieldCheck className="w-3.5 h-3.5 mr-2 text-primary/80" />
            100% Privado & Client-side
          </div>
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight md:leading-[1.1]">
            Seu Estúdio de Imagens <br className="hidden md:block" />
            <span className="text-primary">Definitivo</span>
          </h1>
          <p className="text-lg md:text-xl text-foreground/75 max-w-2xl mt-2 leading-relaxed tracking-normal">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card: Conversor */}
          <Card className="flex flex-col h-full transition-all hover:shadow-lg hover:border-blue-500/50 group bg-gradient-to-br from-background to-blue-500/5">
            <CardHeader>
          ...
          {/* Card: Editor */}
          <Card className="flex flex-col h-full transition-all hover:shadow-lg hover:border-purple-500/50 group bg-gradient-to-br from-background to-purple-500/5">
            <CardHeader>
          ...
          {/* Card: Compressor */}
          <Card className="flex flex-col h-full transition-all hover:shadow-lg hover:border-orange-500/50 group bg-gradient-to-br from-background to-orange-500/5">
            <CardHeader>
